...
const MTN_CONFIG = {
  collection: {
    ...
    accessToken:
      "eyJ0eXAiOiJKV1QiLCJhbGciOiJSMjU2In0.eyJjbGllbnRJZCI6IjUyMTQwMjc3LTBhNjUtNGNhNS1hZDc0LTdmMjEzOWU5NzdmMSIsImV4cGlyZXMiOiIyMDI1LTA3LTI4VDEzOjQ0OjM1LjUxNyIsInNlc3Npb25JZCI6ImY2ZjJmZTcyLTVlZjgtNDEyYS1iOWVhLTNlYzE2MDI0NDU3NCJ9.ddRdpMe6JJ_VtHYZ0iJYhPHJJYV30xXqyEbBBVUqpWUrX0pj3BgrDBWj4dXuWXLCazuDWhv7wC7V5TMpP03zY0wpi7HqAsbhPDL7sCA6B5K9m45AI3TEhorzKYFv8oSpo8ULWG4GWIeTHgeIdQOjD4SNJiKLhTW71jZ6X4-zt3I9xH0hnvzIhFkIno0XzDiDSEAkg3VV-un5zA5TT-LienTXwVtN-Upybt3Mppi7ifd6-96BF9JLjfh3Mq3LbHGcXtRLAIZJyvkJ6vZNc01qYuWuXCHD7S4Ht4B-AO987L_oovNl_iyTbsE_ocAVpvLxbeI_QoCjOB-b51JCYR2eZQ",
...
class PaymentService {
  ...
  async initiateMtnPayment(request: {
    ...
    try {
      ...
      const fetchUrl = `/collection/v1_0/requesttopay`;
      console.log("Fetching from:", fetchUrl); // Debug the URL
